export const COMMANDS = {
  ...
  INPUT_TAP_RUN_SPEED_TEST: '/input:tap-run-speed-test',
  INPUT_TAP_COOKIES_SGH: '/input:tap-cookies-sgh',
  INPUT_TAP_COOKIES_NU: '/input:tap-cookies-nu',
  INPUT_TAP_USA_SGH: '/input:tap-usabutton-sgh',
  INPUT_TAP_USA_RB: '/input:tap-usabutton-rb',
  ...
  INPUT_TAP_VMMV_VMP_RESTART_V4: '/input:tap-vmmv-vmp-restart-v4',
  INPUT_TAP_VMMV_PICTURE_V4: '/input:tap-vmmv-picture-v4',
  INPUT_TAP_VMMV_PICTURE_UPLOAD_V4: '/input:tap-vmmv-picture-upload-v4',
  INPUT_TAP_VMMV_PICTURE_OK_UPLOAD_V4: '/input:tap-vmmv-picture-ok-upload-v4',
  INPUT_TAP_VMMV_MULTIVM: '/input:tap-vmmv-multivm',
  INPUT_TAP_VMMV_TRYON: '/input:tap-vmmv-tryonbutton',
  INPUT_TAP_VMMV_TRYON_SGH: '/input:tap-vmmv-tryonbutton-sgh',
  INPUT_TAP_VMMV_TRYON_RB: '/input:tap-vmmv-tryonbutton-rb',
  INPUT_TAP_VMMV_TRYON_NU: '/input:tap-vmmv-tryonbutton-nu',
  INPUT_TAP_VMMV_TRYON_OO: '/input:tap-vmmv-tryonbutton-oo',
  INPUT_TAP_VMMV_PRIVACY: '/input:tap-vmmv-privacybutton',
  ...
  INPUT_TAP_RTRMV_ZOOM_RB: '/input:tap-rtrmv-zoom-rb',
  INPUT_TAP_RTRMV_START_SGH: '/input:tap-rtrmv-start-sgh',
  INPUT_TAP_RTRMV_START_RB: '/input:tap-rtrmv-start-rb',
  INPUT_TAP_RTRMV_EXPLOSION: '/input:tap-rtrmv-explosion',
  INPUT_TAP_RTRMV_EXPLOSION_RB: '/input:tap-rtrmv-explosion-rb',
